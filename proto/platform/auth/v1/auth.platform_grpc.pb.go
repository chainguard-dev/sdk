...
const (
	...
	Auth_Delete_FullMethodName             = "/chainguard.platform.auth.Auth/Delete"
)
...
type AuthClient interface {
	...
	Delete(ctx context.Context, in *DeletionRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *authClient) Delete(ctx context.Context, in *DeletionRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServer interface {
	...
	Delete(context.Context, *DeletionRequest) (*emptypb.Empty, error)
...
func (UnimplementedAuthServer) GetHeadlessSession(context.Context, *GetHeadlessSessionRequest) (*HeadlessSession, error) {
	return nil, status.Error(codes.Unimplemented, "method GetHeadlessSession not implemented")
}
func (UnimplementedAuthServer) Delete(context.Context, *DeletionRequest) (*emptypb.Empty, error) {
...
func _Auth_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).Delete(ctx, req.(*DeletionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
