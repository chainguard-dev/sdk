...
const (
	Entitlements_List_FullMethodName = "/chainguard.platform.packages.Entitlements/List"
)
...
type EntitlementsClient interface {
	List(ctx context.Context, in *PackageEntitlementFilter, opts ...grpc.CallOption) (*PackageEntitlementList, error)
}
...
func (c *entitlementsClient) List(ctx context.Context, in *PackageEntitlementFilter, opts ...grpc.CallOption) (*PackageEntitlementList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PackageEntitlementList)
...
type EntitlementsServer interface {
	List(context.Context, *PackageEntitlementFilter) (*PackageEntitlementList, error)
...
func (UnimplementedEntitlementsServer) List(context.Context, *PackageEntitlementFilter) (*PackageEntitlementList, error) {
...
func _Entitlements_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PackageEntitlementFilter)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EntitlementsServer).List(ctx, req.(*PackageEntitlementFilter))
	}
...
var Entitlements_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "chainguard.platform.packages.Entitlements",
	...
	Metadata: "entitlements.packages.platform.proto",
}
