...
const file_account_associations_platform_proto_rawDesc = "" +
	"\n" +
	"#account_associations.platform.proto\x12\x17chainguard.platform.iam\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x16annotations/auth.proto\x1a\x18annotations/events.proto\"\x84\t\n" +
	...
	"\x06github\x18\x06 \x01(\v2?.chainguard.platform.iam.AccountAssociations.GitHubInstallationR\x06github\x12W\n" +
	"\n" +
	...
	"\x0eproject_number\x18\x02 \x01(\tR\rprojectNumber\x1a|\n" +
	"\x12GitHubInstallation\x12\x12\n" +
	"\x04host\x18\x01 \x01(\tR\x04host\x12\x15\n" +
	"\x06app_id\x18\x02 \x01(\x03R\x05appId\x12'\n" +
	"\x0finstallation_id\x18\x03 \x01(\x03R\x0einstallationId\x12\x12\n" +
	"\x04name\x18\x04 \x01(\tR\x04name\x1a\xc9\x01\n" +
	"\n" +
	"Chainguard\x12w\n" +
