...
func RegisterPoliciesHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PoliciesServer) error {
	...
	mux.Handle("POST", pattern_Policies_CheckPolicies_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Policies_CheckPolicies_0(annotatedContext, inboundMarshaler, server, req, pathParams)
...
func RegisterPoliciesHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PoliciesClient) error {
	...
	mux.Handle("POST", pattern_Policies_CheckPolicies_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Policies_CheckPolicies_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Policies_CheckPolicies_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 3, 0, 4, 1, 5, 3}, []string{"registry", "v1", "repos", "repo_id"}, "checkPolicies"))
)

var (
	forward_Policies_CheckPolicies_0 = runtime.ForwardResponseMessage
)
