...
type EntitlementsClient interface {
	...
	// rolling 30-day catalog-image swap quota: swaps beyond the quota consume
	// per-tier image capacity until they age out of the window, reducing what can
	// be added. See GetEffectiveEntitlements (swap_quota, swaps_used) for the
	// current budget.
...
func (UnimplementedEntitlementsServer) ListEntitlementImages(context.Context, *EntitlementImagesFilter) (*EntitlementImagesList, error) {
	return nil, status.Error(codes.Unimplemented, "method ListEntitlementImages not implemented")
}
func (UnimplementedEntitlementsServer) ListEntitlementCatalogImages(context.Context, *EntitlementImagesFilter) (*EntitlementImagesList, error) {
	return nil, status.Error(codes.Unimplemented, "method ListEntitlementCatalogImages not implemented")
}
