...
func RegisterPoliciesHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PoliciesServer) error {
	...
	mux.Handle("POST", pattern_Policies_ValidatePolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Policies_ValidatePolicy_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
...
// RegisterDecisionsHandlerServer registers the http handlers for service Decisions to "mux".
// UnaryRPC     :call DecisionsServer directly.
// StreamingRPC :currently unsupported pending https://github.com/grpc/grpc-go/issues/906.
...
func RegisterDecisionsHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DecisionsServer) error {
	...
	mux.Handle("GET", pattern_Decisions_ListDecisions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Decisions_ListDecisions_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
...
// RegisterOverridesHandlerServer registers the http handlers for service Overrides to "mux".
// UnaryRPC     :call OverridesServer directly.
// StreamingRPC :currently unsupported pending https://github.com/grpc/grpc-go/issues/906.
...
func RegisterOverridesHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OverridesServer) error {
	...
	mux.Handle("POST", pattern_Overrides_CreateOverride_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Overrides_CreateOverride_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
	...
	mux.Handle("GET", pattern_Overrides_ListOverrides_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Overrides_ListOverrides_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
	...
	mux.Handle("DELETE", pattern_Overrides_DeleteOverride_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Overrides_DeleteOverride_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
...
func RegisterPoliciesHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PoliciesClient) error {
	...
	mux.Handle("POST", pattern_Policies_ValidatePolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Policies_ValidatePolicy_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
// RegisterDecisionsHandlerFromEndpoint is same as RegisterDecisionsHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterDecisionsHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	conn, err := grpc.NewClient(endpoint, opts...)
	if err != nil {
		return err
	}
...
// RegisterDecisionsHandler registers the http handlers for service Decisions to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterDecisionsHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterDecisionsHandlerClient(ctx, mux, NewDecisionsClient(conn))
}

// RegisterDecisionsHandlerClient registers the http handlers for service Decisions
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "DecisionsClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "DecisionsClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
...
func RegisterDecisionsHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DecisionsClient) error {
	...
	mux.Handle("GET", pattern_Decisions_ListDecisions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Decisions_ListDecisions_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Decisions_ListDecisions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"policies", "v1", "decisions"}, ""))
)

var (
	forward_Decisions_ListDecisions_0 = runtime.ForwardResponseMessage
)

// RegisterOverridesHandlerFromEndpoint is same as RegisterOverridesHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterOverridesHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	conn, err := grpc.NewClient(endpoint, opts...)
	if err != nil {
		return err
	}
...
// RegisterOverridesHandler registers the http handlers for service Overrides to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterOverridesHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterOverridesHandlerClient(ctx, mux, NewOverridesClient(conn))
}

// RegisterOverridesHandlerClient registers the http handlers for service Overrides
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "OverridesClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "OverridesClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
...
func RegisterOverridesHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OverridesClient) error {
	...
	mux.Handle("POST", pattern_Overrides_CreateOverride_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Overrides_CreateOverride_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_Overrides_ListOverrides_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Overrides_ListOverrides_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("DELETE", pattern_Overrides_DeleteOverride_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Overrides_DeleteOverride_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
