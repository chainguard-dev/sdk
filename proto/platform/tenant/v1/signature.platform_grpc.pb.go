...
func (c *signaturesClient) List(ctx context.Context, in *SignatureFilter, opts ...grpc.CallOption) (*SignatureList, error) {
	...
	err := c.cc.Invoke(ctx, Signatures_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSignaturesServer must be embedded to have
...
func (UnimplementedSignaturesServer) testEmbeddedByValue()                    {}
...
func RegisterSignaturesServer(s grpc.ServiceRegistrar, srv SignaturesServer) {
	// If the following call pancis, it indicates UnimplementedSignaturesServer was
