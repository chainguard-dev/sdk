...
func RegisterAttestationsHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AttestationsServer) error {
	...
	mux.Handle("POST", pattern_Attestations_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/chainguard.platform.tenant.Attestations/List", runtime.WithHTTPPathPattern("/chainguard.platform.tenant.Attestations/List"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Attestations_List_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_Attestations_List_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
// "AttestationsClient" to call the correct interceptors. This client ignores the HTTP middlewares.
func RegisterAttestationsHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AttestationsClient) error {
	...
	mux.Handle("POST", pattern_Attestations_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chainguard.platform.tenant.Attestations/List", runtime.WithHTTPPathPattern("/chainguard.platform.tenant.Attestations/List"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Attestations_List_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
