...
var file_attestation_platform_proto_rawDesc = []byte{
	...
	0x2d, 0x5a, 0x2b, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x67, 0x75, 0x61, 0x72, 0x64, 0x2e, 0x64, 0x65,
...
var file_attestation_platform_proto_goTypes = []any{
...
func file_attestation_platform_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_attestation_platform_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_attestation_platform_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_attestation_platform_proto_msgTypes[2].Exporter = func(v any, i int) any {
	...
	file_attestation_platform_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
