...
func (c *vulnReportsClient) List(ctx context.Context, in *VulnReportFilter, opts ...grpc.CallOption) (*VulnReportList, error) {
	...
	err := c.cc.Invoke(ctx, VulnReports_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedVulnReportsServer must be embedded to have
...
func (UnimplementedVulnReportsServer) testEmbeddedByValue()                     {}
...
func RegisterVulnReportsServer(s grpc.ServiceRegistrar, srv VulnReportsServer) {
	// If the following call pancis, it indicates UnimplementedVulnReportsServer was
