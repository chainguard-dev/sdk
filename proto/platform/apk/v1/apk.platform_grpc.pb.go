...
func (UnimplementedAPKServer) ListAPKs(context.Context, *APKFilter) (*APKList, error) {
	return nil, status.Error(codes.Unimplemented, "method ListAPKs not implemented")
}
func (UnimplementedAPKServer) ListAPKSummaries(context.Context, *APKSummaryFilter) (*APKPackageSummaryList, error) {
	return nil, status.Error(codes.Unimplemented, "method ListAPKSummaries not implemented")
}
...
func RegisterAPKServer(s grpc.ServiceRegistrar, srv APKServer) {
	// If the following call panics, it indicates UnimplementedAPKServer was
