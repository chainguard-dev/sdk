...
func RegisterTagsServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TagsServiceServer) error {
	...
	mux.Handle("POST", pattern_TagsService_CreateTag_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/chainguard.platform.registry.v2beta1.TagsService/CreateTag", runtime.WithHTTPPathPattern("/registry/v2beta1/tags/{parent=**}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_TagsService_DeleteTag_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/chainguard.platform.registry.v2beta1.TagsService/DeleteTag", runtime.WithHTTPPathPattern("/registry/v2beta1/tags/{uid=**}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterTagsServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TagsServiceClient) error {
	...
	mux.Handle("POST", pattern_TagsService_CreateTag_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chainguard.platform.registry.v2beta1.TagsService/CreateTag", runtime.WithHTTPPathPattern("/registry/v2beta1/tags/{parent=**}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_TagsService_DeleteTag_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chainguard.platform.registry.v2beta1.TagsService/DeleteTag", runtime.WithHTTPPathPattern("/registry/v2beta1/tags/{uid=**}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_TagsService_CreateTag_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 3, 0, 4, 1, 5, 3}, []string{"registry", "v2beta1", "tags", "parent"}, ""))

	pattern_TagsService_DeleteTag_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 3, 0, 4, 1, 5, 3}, []string{"registry", "v2beta1", "tags", "uid"}, ""))
)
