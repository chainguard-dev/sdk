...
type MockReposServiceClient struct {
	...
	OnListCatalogImages []test.On[*registry.ListCatalogImagesRequest, *registry.ListReposResponse]
...
func (m MockReposServiceClient) ListCatalogImages(_ context.Context, given *registry.ListCatalogImagesRequest, _ ...grpc.CallOption) (*registry.ListReposResponse, error) {
	return test.Match(m.T, m.OnListCatalogImages, given, "list-catalog-images", protocmp.Transform())
}
