...
func RegisterImagesServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ImagesServiceServer) error {
	...
	mux.Handle("GET", pattern_ImagesService_GetArchitectures_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/chainguard.platform.registry.v2.ImagesService/GetArchitectures", runtime.WithHTTPPathPattern("/registry/v2/repos/{repo_uid=**}/digests/{digest}/architectures"))
		if err != nil {
	...
	mux.Handle("GET", pattern_ImagesService_GetSize_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/chainguard.platform.registry.v2.ImagesService/GetSize", runtime.WithHTTPPathPattern("/registry/v2/repos/{repo_uid=**}/digests/{digest}/size"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterImagesServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ImagesServiceClient) error {
	...
	mux.Handle("GET", pattern_ImagesService_GetArchitectures_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chainguard.platform.registry.v2.ImagesService/GetArchitectures", runtime.WithHTTPPathPattern("/registry/v2/repos/{repo_uid=**}/digests/{digest}/architectures"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ImagesService_GetSize_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chainguard.platform.registry.v2.ImagesService/GetSize", runtime.WithHTTPPathPattern("/registry/v2/repos/{repo_uid=**}/digests/{digest}/size"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_ImagesService_GetArchitectures_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 3, 0, 4, 1, 5, 3, 2, 4, 1, 0, 4, 1, 5, 5, 2, 6}, []string{"registry", "v2", "repos", "repo_uid", "digests", "digest", "architectures"}, ""))

	pattern_ImagesService_GetSize_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 3, 0, 4, 1, 5, 3, 2, 4, 1, 0, 4, 1, 5, 5, 2, 6}, []string{"registry", "v2", "repos", "repo_uid", "digests", "digest", "size"}, ""))
)
