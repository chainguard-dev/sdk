...
const (
	TagsService_GetTag_FullMethodName    = "/chainguard.platform.registry.v2.TagsService/GetTag"
	TagsService_ListTags_FullMethodName  = "/chainguard.platform.registry.v2.TagsService/ListTags"
	TagsService_CreateTag_FullMethodName = "/chainguard.platform.registry.v2.TagsService/CreateTag"
	TagsService_DeleteTag_FullMethodName = "/chainguard.platform.registry.v2.TagsService/DeleteTag"
)
...
var TagsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "chainguard.platform.registry.v2.TagsService",
	...
	Metadata: "chainguard/platform/registry/v2/tags.proto",
}
