...
// 	protoc        v7.34.1
// source: chainguard/platform/registry/v2/repos.proto
...
func (CatalogTier) Descriptor() protoreflect.EnumDescriptor {
	return file_chainguard_platform_registry_v2_repos_proto_enumTypes[0].Descriptor()
}

func (CatalogTier) Type() protoreflect.EnumType {
	return &file_chainguard_platform_registry_v2_repos_proto_enumTypes[0]
}
...
type Repo struct {
	...
	// Repositories that sync from another repository inherit the tier from
	// their source, and attempts to change it fail with INVALID_ARGUMENT.
	CatalogTier CatalogTier `protobuf:"varint,4,opt,name=catalog_tier,json=catalogTier,proto3,enum=chainguard.platform.registry.v2.CatalogTier" json:"catalog_tier,omitempty"`
	// Sales grouping labels for the repository.
	// Repositories that sync from another repository inherit bundles from
	// their source, and attempts to change them fail with INVALID_ARGUMENT.
	Bundles []string `protobuf:"bytes,5,rep,name=bundles,proto3" json:"bundles,omitempty"`
	// List of equivalent image names/aliases.
	// Repositories that sync from another repository inherit aliases from
	// their source, and attempts to change them fail with INVALID_ARGUMENT.
	...
	// Repositories that sync from another repository inherit active tags from
	// their source, and attempts to change them fail with INVALID_ARGUMENT.
...
func (x *Repo) Reset() {
	*x = Repo{}
	mi := &file_chainguard_platform_registry_v2_repos_proto_msgTypes[0]
...
func (x *SyncConfig) Reset() {
	*x = SyncConfig{}
	mi := &file_chainguard_platform_registry_v2_repos_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SyncConfig) Descriptor() ([]byte, []int) {
	return file_chainguard_platform_registry_v2_repos_proto_rawDescGZIP(), []int{1}
}
...
func (x *CustomOverlay) Reset() {
	*x = CustomOverlay{}
	mi := &file_chainguard_platform_registry_v2_repos_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomOverlay) Descriptor() ([]byte, []int) {
	return file_chainguard_platform_registry_v2_repos_proto_rawDescGZIP(), []int{2}
}
...
func (x *GetRepoRequest) Reset() {
	*x = GetRepoRequest{}
	mi := &file_chainguard_platform_registry_v2_repos_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetRepoRequest) Descriptor() ([]byte, []int) {
	return file_chainguard_platform_registry_v2_repos_proto_rawDescGZIP(), []int{3}
}
...
func (x *DeleteRepoRequest) Reset() {
	*x = DeleteRepoRequest{}
	mi := &file_chainguard_platform_registry_v2_repos_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteRepoRequest) Descriptor() ([]byte, []int) {
	return file_chainguard_platform_registry_v2_repos_proto_rawDescGZIP(), []int{4}
}
...
func (x *CreateRepoRequest) Reset() {
	*x = CreateRepoRequest{}
	mi := &file_chainguard_platform_registry_v2_repos_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateRepoRequest) Descriptor() ([]byte, []int) {
	return file_chainguard_platform_registry_v2_repos_proto_rawDescGZIP(), []int{5}
}
...
func (x *UpdateRepoRequest) Reset() {
	*x = UpdateRepoRequest{}
	mi := &file_chainguard_platform_registry_v2_repos_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateRepoRequest) Descriptor() ([]byte, []int) {
	return file_chainguard_platform_registry_v2_repos_proto_rawDescGZIP(), []int{6}
}
...
func (x *ListReposRequest) Reset() {
	*x = ListReposRequest{}
	mi := &file_chainguard_platform_registry_v2_repos_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListReposRequest) Descriptor() ([]byte, []int) {
	return file_chainguard_platform_registry_v2_repos_proto_rawDescGZIP(), []int{7}
}
...
func (x *ListReposResponse) Reset() {
	*x = ListReposResponse{}
	mi := &file_chainguard_platform_registry_v2_repos_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListReposResponse) Descriptor() ([]byte, []int) {
	return file_chainguard_platform_registry_v2_repos_proto_rawDescGZIP(), []int{8}
}
...
// RepoReadme is the Markdown README describing a repository.
// It is a singleton sub-resource of Repo.
type RepoReadme struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// UID of the repository this README describes.
	Uid string `protobuf:"bytes,1,opt,name=uid,proto3" json:"uid,omitempty"`
	// Raw Markdown content of the README.
	// On repositories with a sync_config the README is synced from the source
	// repository.
...
func (x *RepoReadme) Reset() {
	*x = RepoReadme{}
	mi := &file_chainguard_platform_registry_v2_repos_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RepoReadme) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RepoReadme) ProtoMessage() {}

func (x *RepoReadme) ProtoReflect() protoreflect.Message {
	mi := &file_chainguard_platform_registry_v2_repos_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RepoReadme.ProtoReflect.Descriptor instead.
func (*RepoReadme) Descriptor() ([]byte, []int) {
	return file_chainguard_platform_registry_v2_repos_proto_rawDescGZIP(), []int{9}
}

func (x *RepoReadme) GetUid() string {
	if x != nil {
		return x.Uid
	}
	return ""
...
func (x *RepoReadme) GetContent() string {
	if x != nil {
		return x.Content
	}
	return ""
...
// GetRepoReadmeRequest is the request message for GetRepoReadme.
type GetRepoReadmeRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// UID of the repository whose README to retrieve.
	Uid           string `protobuf:"bytes,1,opt,name=uid,proto3" json:"uid,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetRepoReadmeRequest) Reset() {
	*x = GetRepoReadmeRequest{}
	mi := &file_chainguard_platform_registry_v2_repos_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetRepoReadmeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetRepoReadmeRequest) ProtoMessage() {}

func (x *GetRepoReadmeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_chainguard_platform_registry_v2_repos_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetRepoReadmeRequest.ProtoReflect.Descriptor instead.
func (*GetRepoReadmeRequest) Descriptor() ([]byte, []int) {
	return file_chainguard_platform_registry_v2_repos_proto_rawDescGZIP(), []int{10}
}

func (x *GetRepoReadmeRequest) GetUid() string {
	if x != nil {
		return x.Uid
	}
	return ""
...
// UpdateRepoReadmeRequest is the request message for UpdateRepoReadme.
type UpdateRepoReadmeRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// README to update. The uid identifies the repository.
	RepoReadme *RepoReadme `protobuf:"bytes,1,opt,name=repo_readme,json=repoReadme,proto3" json:"repo_readme,omitempty"`
	// Fields to update. When omitted, inferred from the populated fields.
	UpdateMask    *fieldmaskpb.FieldMask `protobuf:"bytes,2,opt,name=update_mask,json=updateMask,proto3" json:"update_mask,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UpdateRepoReadmeRequest) Reset() {
	*x = UpdateRepoReadmeRequest{}
	mi := &file_chainguard_platform_registry_v2_repos_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UpdateRepoReadmeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateRepoReadmeRequest) ProtoMessage() {}

func (x *UpdateRepoReadmeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_chainguard_platform_registry_v2_repos_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateRepoReadmeRequest.ProtoReflect.Descriptor instead.
func (*UpdateRepoReadmeRequest) Descriptor() ([]byte, []int) {
	return file_chainguard_platform_registry_v2_repos_proto_rawDescGZIP(), []int{11}
}

func (x *UpdateRepoReadmeRequest) GetRepoReadme() *RepoReadme {
	if x != nil {
		return x.RepoReadme
	}
	return nil
...
func (x *UpdateRepoReadmeRequest) GetUpdateMask() *fieldmaskpb.FieldMask {
	if x != nil {
		return x.UpdateMask
	}
	return nil
...
func (x *CustomOverlay_ImageContents) Reset() {
	*x = CustomOverlay_ImageContents{}
	mi := &file_chainguard_platform_registry_v2_repos_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *CustomOverlay_ImageContents) GetRuntimeKeyring() []*CustomOverlay_ImageContents_RuntimeKeyringEntry {
	if x != nil {
...
type CustomOverlay_ImageContents_RuntimeKeyringEntry struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *CustomOverlay_ImageContents_RuntimeKeyringEntry) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *CustomOverlay_ImageContents_RuntimeKeyringEntry) GetContent() string {
	if x != nil {
		return x.Content
	}
	return ""
...
var File_chainguard_platform_registry_v2_repos_proto protoreflect.FileDescriptor

const file_chainguard_platform_registry_v2_repos_proto_rawDesc = "" +
	"\n" +
	"+chainguard/platform/registry/v2/repos.proto\x12\x1fchainguard.platform.registry.v2\x1a\x16annotations/auth.proto\x1a\x18annotations/events.proto\x1a\x15annotations/mcp.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a&platform/common/v1/uidp.platform.proto\"\xa8\x05\n" +
	"\x04Repo\x12\x1c\n" +
	...
	"\vdescription\x18\x03 \x01(\tB\x04\xe2A\x01\x01R\vdescription\x12U\n" +
	"\fcatalog_tier\x18\x04 \x01(\x0e2,.chainguard.platform.registry.v2.CatalogTierB\x04\xe2A\x01\x01R\vcatalogTier\x12\x1e\n" +
	...
	"activeTags\x12S\n" +
	"\vsync_config\x18\t \x01(\v2+.chainguard.platform.registry.v2.SyncConfigB\x04\xe2A\x01\x01R\vsync_config\x12[\n" +
	"\x0ecustom_overlay\x18\n" +
	" \x01(\v2..chainguard.platform.registry.v2.CustomOverlayB\x04\xe2A\x01\x01R\rcustomOverlay\x12A\n" +
	...
	"\x0fruntime_keyring\x18\x03 \x03(\v2P.chainguard.platform.registry.v2.CustomOverlay.ImageContents.RuntimeKeyringEntryB\x04\xe2A\x01\x01R\x0eruntimeKeyring\x1aO\n" +
	"\x13RuntimeKeyringEntry\x12\x18\n" +
	"\x04name\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\x04name\x12\x1e\n" +
	"\acontent\x18\x02 \x01(\tB\x04\xe2A\x01\x02R\acontent\x1a\x80\x04\n" +
	"\bAccounts\x12\x1b\n" +
	"\x06run_as\x18\x01 \x01(\tB\x04\xe2A\x01\x01R\x05runAs\x12X\n" +
	"\x05users\x18\x02 \x03(\v2<.chainguard.platform.registry.v2.CustomOverlay.Accounts.UserB\x04\xe2A\x01\x01R\x05users\x12[\n" +
	"\x06groups\x18\x03 \x03(\v2=.chainguard.platform.registry.v2.CustomOverlay.Accounts.GroupB\x04\xe2A\x01\x01R\x06groups\x1a\xba\x01\n" +
	"\x04User\x12 \n" +
	...
	"\amembers\x18\x03 \x03(\tB\x04\xe2A\x01\x01R\amembers\x1a\xf2\x01\n" +
	"\fCertificates\x12q\n" +
	"\n" +
	"additional\x18\x01 \x03(\v2K.chainguard.platform.registry.v2.CustomOverlay.Certificates.AdditionalEntryB\x04\xe2A\x01\x01R\n" +
	"additional\x12\"\n" +
	...
	"\x03uid\x18\x01 \x01(\tB\n" +
	"\xe2A\x01\x02\x90\xaf\xa8\xd2\x05\x01R\x03uid\"x\n" +
	"\x11CreateRepoRequest\x12\"\n" +
	"\x06parent\x18\x01 \x01(\tB\n" +
	"\xe2A\x01\x02\x90\xaf\xa8\xd2\x05\x01R\x06parent\x12?\n" +
	"\x04repo\x18\x02 \x01(\v2%.chainguard.platform.registry.v2.RepoB\x04\xe2A\x01\x02R\x04repo\"\x9d\x01\n" +
	"\x11UpdateRepoRequest\x12E\n" +
	"\x04repo\x18\x01 \x01(\v2%.chainguard.platform.registry.v2.RepoB\n" +
	...
	"\x05_nameJ\x04\b\x03\x10\x04R\x0eexclude_readme\"\xc8\x01\n" +
	"\x11ListReposResponse\x12;\n" +
	"\x05repos\x18\x01 \x03(\v2%.chainguard.platform.registry.v2.RepoR\x05repos\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12$\n" +
	"\vtotal_count\x18\x03 \x01(\x03H\x00R\n" +
	"totalCount\x88\x01\x01\x12\x18\n" +
	"\askipped\x18\x04 \x01(\x05R\askippedB\x0e\n" +
	"\f_total_count\"\xa1\x01\n" +
	"\n" +
	"RepoReadme\x12\x1c\n" +
	"\x03uid\x18\x01 \x01(\tB\n" +
	"\xe2A\x01\x03\x90\xaf\xa8\xd2\x05\x01R\x03uid\x12\x1e\n" +
	"\acontent\x18\x02 \x01(\tB\x04\xe2A\x01\x01R\acontent:U\xeaAR\n" +
	"\"registry.chainguard.dev/RepoReadme\x12\x13repos/{repo}/readme*\vrepoReadmes2\n" +
	"repoReadme\"4\n" +
	"\x14GetRepoReadmeRequest\x12\x1c\n" +
	"\x03uid\x18\x01 \x01(\tB\n" +
	"\xe2A\x01\x02\x90\xaf\xa8\xd2\x05\x01R\x03uid\"\xb6\x01\n" +
	"\x17UpdateRepoReadmeRequest\x12X\n" +
	"\vrepo_readme\x18\x01 \x01(\v2+.chainguard.platform.registry.v2.RepoReadmeB\n" +
	"\xe2A\x01\x02\x90\xaf\xa8\xd2\x05\x01R\n" +
	"repoReadme\x12A\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskB\x04\xe2A\x01\x01R\n" +
	"updateMask*\xc4\x01\n" +
	...
	"\x17CATALOG_TIER_COMMERCIAL\x10\x062\xbf\x0f\n" +
	"\fReposService\x12\xcf\x01\n" +
	"\aGetRepo\x12/.chainguard.platform.registry.v2.GetRepoRequest\x1a%.chainguard.platform.registry.v2.Repo\"l\x82\xd3\xe4\x93\x02\x1d\x12\x1b/registry/v2/repos/{uid=**}\x8a\xaf\xa8\xd2\x05\x06\x12\x04\n" +
	"\x02\xc5\f\x9a\xaf\xa8\xd2\x057\n" +
	"-Get a container image repository by its UIDP.\x18\x01 \x00(\x010\x00\x12\xac\x02\n" +
	"\n" +
	"CreateRepo\x122.chainguard.platform.registry.v2.CreateRepoRequest\x1a%.chainguard.platform.registry.v2.Repo\"\xc2\x01\x82\xd3\xe4\x93\x02&:\x04repo\"\x1e/registry/v2/repos/{parent=**}\x8a\xaf\xa8\xd2\x05\x06\x12\x04\n" +
	"\x02\xc3\f\x9a\xaf\xa8\xd2\x05?\n" +
	"9Create a container image repository under a parent group. \x000\x00\xc2\xf0\x8e\xfc\v?\n" +
	"4dev.chainguard.api.platform.registry.repo.created.v1\x12\x05group\x18\x01\x12\xac\x02\n" +
	"\n" +
	"UpdateRepo\x122.chainguard.platform.registry.v2.UpdateRepoRequest\x1a%.chainguard.platform.registry.v2.Repo\"\xc2\x01\x82\xd3\xe4\x93\x02(:\x04repo2 /registry/v2/repos/{repo.uid=**}\x8a\xaf\xa8\xd2\x05\x06\x12\x04\n" +
	"\x02\xc4\f\x9a\xaf\xa8\xd2\x05=\n" +
	"5Update a container image repository's mutable fields. \x00(\x010\x00\xc2\xf0\x8e\xfc\v?\n" +
	"4dev.chainguard.api.platform.registry.repo.updated.v1\x12\x05group\x18\x01\x12\x8d\x02\n" +
	"\n" +
	"DeleteRepo\x122.chainguard.platform.registry.v2.DeleteRepoRequest\x1a\x16.google.protobuf.Empty\"\xb2\x01\x82\xd3\xe4\x93\x02\x1d*\x1b/registry/v2/repos/{uid=**}\x8a\xaf\xa8\xd2\x05\x06\x12\x04\n" +
	"\x02\xc6\f\x9a\xaf\xa8\xd2\x058\n" +
	"0Delete a container image repository by its UIDP. \x01(\x010\x00\xc2\xf0\x8e\xfc\v?\n" +
	"4dev.chainguard.api.platform.registry.repo.deleted.v1\x12\x05group\x18\x01\x12\x93\x02\n" +
	"\tListRepos\x121.chainguard.platform.registry.v2.ListReposRequest\x1a2.chainguard.platform.registry.v2.ListReposResponse\"\x9e\x01\x82\xd3\xe4\x93\x02\x14\x12\x12/registry/v2/repos\x8a\xaf\xa8\xd2\x05\b\x12\x06\n" +
	"\x02\xc5\f\x10\x01\x9a\xaf\xa8\xd2\x05p\n" +
	"fList container image repositories the caller has access to. Supports filtering by name and pagination.\x18\x01 \x00(\x010\x00\x12\xf7\x01\n" +
	"\rGetRepoReadme\x125.chainguard.platform.registry.v2.GetRepoReadmeRequest\x1a+.chainguard.platform.registry.v2.RepoReadme\"\x81\x01\x82\xd3\xe4\x93\x02$\x12\"/registry/v2/repos/{uid=**}/readme\x8a\xaf\xa8\xd2\x05\x06\x12\x04\n" +
	"\x02\xc5\f\x9a\xaf\xa8\xd2\x05E\n" +
	"9Get the Markdown README for a container image repository.\x10\x01\x18\x01 \x00(\x010\x00\x12\xde\x02\n" +
	"\x10UpdateRepoReadme\x128.chainguard.platform.registry.v2.UpdateRepoReadmeRequest\x1a+.chainguard.platform.registry.v2.RepoReadme\"\xe2\x01\x82\xd3\xe4\x93\x02=:\vrepo_readme2./registry/v2/repos/{repo_readme.uid=**}/readme\x8a\xaf\xa8\xd2\x05\b\x12\x06\n" +
	"\x04\xc4\f\xd1\f\x9a\xaf\xa8\xd2\x05F\n" +
	"<Update the Markdown README for a container image repository.\x10\x01 \x00(\x010\x00\xc2\xf0\x8e\xfc\v?\n" +
	"4dev.chainguard.api.platform.registry.repo.updated.v1\x12\x05group\x18\x01Bm\n" +
	"#com.chainguard.platform.registry.v2B\n" +
	"ReposProtoP\x01Z8chainguard.dev/sdk/proto/chainguard/platform/registry/v2b\x06proto3"

var (
	file_chainguard_platform_registry_v2_repos_proto_rawDescOnce sync.Once
	file_chainguard_platform_registry_v2_repos_proto_rawDescData []byte
)

func file_chainguard_platform_registry_v2_repos_proto_rawDescGZIP() []byte {
	file_chainguard_platform_registry_v2_repos_proto_rawDescOnce.Do(func() {
		file_chainguard_platform_registry_v2_repos_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_chainguard_platform_registry_v2_repos_proto_rawDesc), len(file_chainguard_platform_registry_v2_repos_proto_rawDesc)))
	})
...
var file_chainguard_platform_registry_v2_repos_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_chainguard_platform_registry_v2_repos_proto_goTypes = []any{
	...
	(*ListReposRequest)(nil),            // 8: chainguard.platform.registry.v2.ListReposRequest
	(*ListReposResponse)(nil),           // 9: chainguard.platform.registry.v2.ListReposResponse
	(*RepoReadme)(nil),                  // 10: chainguard.platform.registry.v2.RepoReadme
	(*GetRepoReadmeRequest)(nil),        // 11: chainguard.platform.registry.v2.GetRepoReadmeRequest
	(*UpdateRepoReadmeRequest)(nil),     // 12: chainguard.platform.registry.v2.UpdateRepoReadmeRequest
	nil,                                 // 13: chainguard.platform.registry.v2.CustomOverlay.EnvironmentEntry
	nil,                                 // 14: chainguard.platform.registry.v2.CustomOverlay.AnnotationsEntry
	(*CustomOverlay_ImageContents)(nil), // 15: chainguard.platform.registry.v2.CustomOverlay.ImageContents
	(*CustomOverlay_Accounts)(nil),      // 16: chainguard.platform.registry.v2.CustomOverlay.Accounts
	(*CustomOverlay_Certificates)(nil),  // 17: chainguard.platform.registry.v2.CustomOverlay.Certificates
	(*CustomOverlay_ImageContents_RuntimeKeyringEntry)(nil), // 18: chainguard.platform.registry.v2.CustomOverlay.ImageContents.RuntimeKeyringEntry
	(*CustomOverlay_Accounts_User)(nil),                     // 19: chainguard.platform.registry.v2.CustomOverlay.Accounts.User
	(*CustomOverlay_Accounts_Group)(nil),                    // 20: chainguard.platform.registry.v2.CustomOverlay.Accounts.Group
	(*CustomOverlay_Certificates_AdditionalEntry)(nil),      // 21: chainguard.platform.registry.v2.CustomOverlay.Certificates.AdditionalEntry
...
var file_chainguard_platform_registry_v2_repos_proto_depIdxs = []int32{
	...
	22, // 3: chainguard.platform.registry.v2.Repo.create_time:type_name -> google.protobuf.Timestamp
	22, // 4: chainguard.platform.registry.v2.Repo.update_time:type_name -> google.protobuf.Timestamp
	22, // 5: chainguard.platform.registry.v2.SyncConfig.expiration_time:type_name -> google.protobuf.Timestamp
	15, // 6: chainguard.platform.registry.v2.CustomOverlay.contents:type_name -> chainguard.platform.registry.v2.CustomOverlay.ImageContents
	13, // 7: chainguard.platform.registry.v2.CustomOverlay.environment:type_name -> chainguard.platform.registry.v2.CustomOverlay.EnvironmentEntry
	14, // 8: chainguard.platform.registry.v2.CustomOverlay.annotations:type_name -> chainguard.platform.registry.v2.CustomOverlay.AnnotationsEntry
	16, // 9: chainguard.platform.registry.v2.CustomOverlay.accounts:type_name -> chainguard.platform.registry.v2.CustomOverlay.Accounts
	17, // 10: chainguard.platform.registry.v2.CustomOverlay.certificates:type_name -> chainguard.platform.registry.v2.CustomOverlay.Certificates
	...
	23, // 13: chainguard.platform.registry.v2.UpdateRepoRequest.update_mask:type_name -> google.protobuf.FieldMask
	24, // 14: chainguard.platform.registry.v2.ListReposRequest.uidp:type_name -> chainguard.platform.common.UIDPFilter
	1,  // 15: chainguard.platform.registry.v2.ListReposResponse.repos:type_name -> chainguard.platform.registry.v2.Repo
	10, // 16: chainguard.platform.registry.v2.UpdateRepoReadmeRequest.repo_readme:type_name -> chainguard.platform.registry.v2.RepoReadme
	23, // 17: chainguard.platform.registry.v2.UpdateRepoReadmeRequest.update_mask:type_name -> google.protobuf.FieldMask
	18, // 18: chainguard.platform.registry.v2.CustomOverlay.ImageContents.runtime_keyring:type_name -> chainguard.platform.registry.v2.CustomOverlay.ImageContents.RuntimeKeyringEntry
	19, // 19: chainguard.platform.registry.v2.CustomOverlay.Accounts.users:type_name -> chainguard.platform.registry.v2.CustomOverlay.Accounts.User
	20, // 20: chainguard.platform.registry.v2.CustomOverlay.Accounts.groups:type_name -> chainguard.platform.registry.v2.CustomOverlay.Accounts.Group
	21, // 21: chainguard.platform.registry.v2.CustomOverlay.Certificates.additional:type_name -> chainguard.platform.registry.v2.CustomOverlay.Certificates.AdditionalEntry
	...
	8,  // 26: chainguard.platform.registry.v2.ReposService.ListRepos:input_type -> chainguard.platform.registry.v2.ListReposRequest
	11, // 27: chainguard.platform.registry.v2.ReposService.GetRepoReadme:input_type -> chainguard.platform.registry.v2.GetRepoReadmeRequest
	12, // 28: chainguard.platform.registry.v2.ReposService.UpdateRepoReadme:input_type -> chainguard.platform.registry.v2.UpdateRepoReadmeRequest
	1,  // 29: chainguard.platform.registry.v2.ReposService.GetRepo:output_type -> chainguard.platform.registry.v2.Repo
	1,  // 30: chainguard.platform.registry.v2.ReposService.CreateRepo:output_type -> chainguard.platform.registry.v2.Repo
	1,  // 31: chainguard.platform.registry.v2.ReposService.UpdateRepo:output_type -> chainguard.platform.registry.v2.Repo
	25, // 32: chainguard.platform.registry.v2.ReposService.DeleteRepo:output_type -> google.protobuf.Empty
	9,  // 33: chainguard.platform.registry.v2.ReposService.ListRepos:output_type -> chainguard.platform.registry.v2.ListReposResponse
	10, // 34: chainguard.platform.registry.v2.ReposService.GetRepoReadme:output_type -> chainguard.platform.registry.v2.RepoReadme
	10, // 35: chainguard.platform.registry.v2.ReposService.UpdateRepoReadme:output_type -> chainguard.platform.registry.v2.RepoReadme
...
func file_chainguard_platform_registry_v2_repos_proto_init() {
	if File_chainguard_platform_registry_v2_repos_proto != nil {
		return
	}
	file_chainguard_platform_registry_v2_repos_proto_msgTypes[7].OneofWrappers = []any{}
	file_chainguard_platform_registry_v2_repos_proto_msgTypes[8].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_chainguard_platform_registry_v2_repos_proto_goTypes,
		DependencyIndexes: file_chainguard_platform_registry_v2_repos_proto_depIdxs,
		EnumInfos:         file_chainguard_platform_registry_v2_repos_proto_enumTypes,
		MessageInfos:      file_chainguard_platform_registry_v2_repos_proto_msgTypes,
	}.Build()
	File_chainguard_platform_registry_v2_repos_proto = out.File
	file_chainguard_platform_registry_v2_repos_proto_goTypes = nil
	file_chainguard_platform_registry_v2_repos_proto_depIdxs = nil
}
