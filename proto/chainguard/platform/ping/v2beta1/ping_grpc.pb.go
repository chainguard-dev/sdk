...
const (
	PingService_Ping_FullMethodName = "/chainguard.platform.ping.v2beta1.PingService/Ping"
)
...
type PingServiceClient interface {
	// Ping checks API availability. No authentication required.
...
var PingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "chainguard.platform.ping.v2beta1.PingService",
	...
	Metadata: "chainguard/platform/ping/v2beta1/ping.proto",
}
