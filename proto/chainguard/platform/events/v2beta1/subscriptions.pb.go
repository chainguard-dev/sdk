...
const file_chainguard_platform_events_v2beta1_subscriptions_proto_rawDesc = "" +
	...
	"\x03uid\x18\x01 \x01(\tB\n" +
	"\xe2A\x01\x02\x90\xaf\xa8\xd2\x05\x01R\x03uid2\xc3\t\n" +
	...
	"&Get an event subscription by its UIDP.\x18\x01 \x00(\x010\x00\x12\xdb\x02\n" +
	"\x12CreateSubscription\x12=.chainguard.platform.events.v2beta1.CreateSubscriptionRequest\x1a0.chainguard.platform.events.v2beta1.Subscription\"\xd3\x01\x82\xd3\xe4\x93\x029:\fsubscription\")/events/v2beta1/subscriptions/{parent=**}\x8a\xaf\xa8\xd2\x05\x06\x12\x04\n" +
	"\x02\xdd\v\x9a\xaf\xa8\xd2\x05@\n" +
	"8Create a new event subscription (webhook) under a group.\x10\x01 \x000\x00\xc2\xf0\x8e\xfc\v<\n" +
	...
	"]List event subscriptions the caller has access to. Supports filtering by UIDP and pagination.\x18\x01 \x00(\x010\x00\x12\xa2\x02\n" +
	"\x12DeleteSubscription\x12=.chainguard.platform.events.v2beta1.DeleteSubscriptionRequest\x1a\x16.google.protobuf.Empty\"\xb4\x01\x82\xd3\xe4\x93\x02(*&/events/v2beta1/subscriptions/{uid=**}\x8a\xaf\xa8\xd2\x05\x06\x12\x04\n" +
	"\x02\xe0\v\x9a\xaf\xa8\xd2\x052\n" +
	"(Delete an event subscription by its UID.\x10\x01 \x01(\x010\x00\xc2\xf0\x8e\xfc\v<\n" +
