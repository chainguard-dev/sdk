...
func RegisterSubscriptionsServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SubscriptionsServiceServer) error {
	...
	mux.Handle("GET", pattern_SubscriptionsService_GetSubscription_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/chainguard.platform.events.v2beta1.SubscriptionsService/GetSubscription", runtime.WithHTTPPathPattern("/events/v2beta1/subscriptions/{uid=**}"))
		if err != nil {
...
func RegisterSubscriptionsServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SubscriptionsServiceClient) error {
	...
	mux.Handle("GET", pattern_SubscriptionsService_GetSubscription_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chainguard.platform.events.v2beta1.SubscriptionsService/GetSubscription", runtime.WithHTTPPathPattern("/events/v2beta1/subscriptions/{uid=**}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_SubscriptionsService_GetSubscription_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 3, 0, 4, 1, 5, 3}, []string{"events", "v2beta1", "subscriptions", "uid"}, ""))
