...
var (
	_ events.Eventable  = (*Subscription)(nil)
	_ events.Extendable = (*Subscription)(nil)
	_ events.Eventable  = (*DeleteSubscriptionRequest)(nil)
	_ events.Extendable = (*DeleteSubscriptionRequest)(nil)
)
