...
// UnaryRPC     :call SecurityAdvisoryServiceServer directly.
...
func RegisterSecurityAdvisoryServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SecurityAdvisoryServiceServer) error {
	...
	mux.Handle("GET", pattern_SecurityAdvisoryService_ListDocuments_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/chainguard.platform.advisory.v2beta1.SecurityAdvisoryService/ListDocuments", runtime.WithHTTPPathPattern("/advisory/v2beta1/documents"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_SecurityAdvisoryService_ListDocuments_0(annotatedContext, inboundMarshaler, server, req, pathParams)
	...
	mux.Handle("GET", pattern_SecurityAdvisoryService_ListVulnerabilityMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/chainguard.platform.advisory.v2beta1.SecurityAdvisoryService/ListVulnerabilityMetadata", runtime.WithHTTPPathPattern("/advisory/v2beta1/metadata"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_SecurityAdvisoryService_ListVulnerabilityMetadata_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
	...
	mux.Handle("GET", pattern_SecurityAdvisoryService_ListResolvedVulnsReports_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/chainguard.platform.advisory.v2beta1.SecurityAdvisoryService/ListResolvedVulnsReports", runtime.WithHTTPPathPattern("/advisory/v2beta1/images/resolvedVulns"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_SecurityAdvisoryService_ListResolvedVulnsReports_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
...
// RegisterSecurityAdvisoryServiceHandlerFromEndpoint is same as RegisterSecurityAdvisoryServiceHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterSecurityAdvisoryServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
...
// RegisterSecurityAdvisoryServiceHandler registers the http handlers for service SecurityAdvisoryService to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterSecurityAdvisoryServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterSecurityAdvisoryServiceHandlerClient(ctx, mux, NewSecurityAdvisoryServiceClient(conn))
}

// RegisterSecurityAdvisoryServiceHandlerClient registers the http handlers for service SecurityAdvisoryService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "SecurityAdvisoryServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "SecurityAdvisoryServiceClient"
...
func RegisterSecurityAdvisoryServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SecurityAdvisoryServiceClient) error {
	...
	mux.Handle("GET", pattern_SecurityAdvisoryService_ListDocuments_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chainguard.platform.advisory.v2beta1.SecurityAdvisoryService/ListDocuments", runtime.WithHTTPPathPattern("/advisory/v2beta1/documents"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_SecurityAdvisoryService_ListDocuments_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_SecurityAdvisoryService_ListVulnerabilityMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chainguard.platform.advisory.v2beta1.SecurityAdvisoryService/ListVulnerabilityMetadata", runtime.WithHTTPPathPattern("/advisory/v2beta1/metadata"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_SecurityAdvisoryService_ListVulnerabilityMetadata_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_SecurityAdvisoryService_ListResolvedVulnsReports_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chainguard.platform.advisory.v2beta1.SecurityAdvisoryService/ListResolvedVulnsReports", runtime.WithHTTPPathPattern("/advisory/v2beta1/images/resolvedVulns"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_SecurityAdvisoryService_ListResolvedVulnsReports_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_SecurityAdvisoryService_ListDocuments_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"advisory", "v2beta1", "documents"}, ""))

	pattern_SecurityAdvisoryService_ListVulnerabilityMetadata_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"advisory", "v2beta1", "metadata"}, ""))

	pattern_SecurityAdvisoryService_ListResolvedVulnsReports_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"advisory", "v2beta1", "images", "resolvedVulns"}, ""))
)
