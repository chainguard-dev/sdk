...
import (
	...
	v2 "chainguard.dev/sdk/proto/chainguard/platform/iam/v2"
)
...
func ExampleClients_GroupsService() {
	...
	group, err := clients.GroupsService().GetGroup(ctx, &v2.GetGroupRequest{
...
func ExampleClients_IdentitiesService() {
	...
	identity, err := clients.IdentitiesService().GetIdentity(ctx, &v2.GetIdentityRequest{
...
func ExampleClients_RolesService() {
	...
	// Get a specific role
	role, err := clients.RolesService().GetRole(ctx, &v2.GetRoleRequest{
...
func ExampleClients_RoleBindingsService() {
	...
	roleBinding, err := clients.RoleBindingsService().GetRoleBinding(ctx, &v2.GetRoleBindingRequest{
...
func ExampleClients_ListIdentitiesIter() {
	...
	for identity, err := range clients.ListIdentitiesIter(ctx, &v2.ListIdentitiesRequest{
		PageSize: 50,
	}) {
		if err != nil {
			panic(err)
...
func ExampleClients_ListIdentitiesAll() {
	...
	identities, err := clients.ListIdentitiesAll(ctx, &v2.ListIdentitiesRequest{})
	if err != nil {
		panic(err)
	}
...
func ExampleClients_ListRolesIter() {
	...
	for role, err := range clients.ListRolesIter(ctx, &v2.ListRolesRequest{
		PageSize: 50,
	}) {
		if err != nil {
			panic(err)
...
func ExampleClients_ListRolesAll() {
	...
	roles, err := clients.ListRolesAll(ctx, &v2.ListRolesRequest{})
	if err != nil {
		panic(err)
	}
...
func ExampleClients_ListRoleBindingsIter() {
	...
	for roleBinding, err := range clients.ListRoleBindingsIter(ctx, &v2.ListRoleBindingsRequest{
		PageSize: 50,
	}) {
		if err != nil {
			panic(err)
...
func ExampleClients_ListRoleBindingsAll() {
	...
	roleBindings, err := clients.ListRoleBindingsAll(ctx, &v2.ListRoleBindingsRequest{})
	if err != nil {
		panic(err)
	}
