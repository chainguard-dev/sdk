...
const file_chainguard_platform_iam_v2_identity_providers_proto_rawDesc = "" +
	...
	"\x04scim\x18\x15 \x01(\v21.chainguard.platform.iam.v2.IdentityProvider.SCIMB\x04\xe2A\x01\x03R\x04scim\x1a\xfc\x03\n" +
	"\x04OIDC\x12\x1c\n" +
