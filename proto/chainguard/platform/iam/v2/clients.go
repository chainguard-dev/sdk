...
// Package v2 provides clients for IAM v2 services.
package v2
...
// Clients provides access to v2 IAM service clients.
...
// NewClientsFromConnection creates v2 IAM clients from an existing gRPC connection.
