...
// AccountAssociationsService implements [v2.Clients].
...
// ListExternalGroupRoleMappingsAll implements [v2.Clients].
...
// ListExternalGroupRoleMappingsIter implements [v2.Clients].
...
// TermsService implements [v2.Clients].
func (m *MockClients) TermsService() iam.TermsServiceClient {
	return &m.TermsServiceClient
}

// ListAccountAssociationsAll implements [v2.Clients].
...
// ListAccountAssociationsIter implements [v2.Clients].
...
// ListGroupInvitesAll implements [v2.Clients].
...
// ListGroupInvitesIter implements [v2.Clients].
...
// ListGroupsAll implements [v2.Clients].
...
// ListGroupsIter implements [v2.Clients].
...
// ListIdentitiesAll implements [v2.Clients].
...
// ListIdentitiesIter implements [v2.Clients].
...
// ListIdentityProvidersAll implements [v2.Clients].
...
// ListIdentityProvidersIter implements [v2.Clients].
...
// ListRoleBindingsAll implements [v2.Clients].
...
// ListRoleBindingsIter implements [v2.Clients].
...
// ListRolesAll implements [v2.Clients].
...
// ListRolesIter implements [v2.Clients].
...
// ListTermsAcceptancesAll implements [v2.Clients].
...
// ListTermsAcceptancesIter implements [v2.Clients].
