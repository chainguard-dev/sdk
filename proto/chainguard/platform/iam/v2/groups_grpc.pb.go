...
const (
	GroupsService_GetGroup_FullMethodName           = "/chainguard.platform.iam.v2.GroupsService/GetGroup"
	GroupsService_DeleteGroup_FullMethodName        = "/chainguard.platform.iam.v2.GroupsService/DeleteGroup"
	GroupsService_ListGroups_FullMethodName         = "/chainguard.platform.iam.v2.GroupsService/ListGroups"
	GroupsService_CreateGroup_FullMethodName        = "/chainguard.platform.iam.v2.GroupsService/CreateGroup"
	GroupsService_UpdateGroup_FullMethodName        = "/chainguard.platform.iam.v2.GroupsService/UpdateGroup"
	GroupsService_LookupGroup_FullMethodName        = "/chainguard.platform.iam.v2.GroupsService/LookupGroup"
	GroupsService_RequestGroupAccess_FullMethodName = "/chainguard.platform.iam.v2.GroupsService/RequestGroupAccess"
	GroupsService_CheckEligibility_FullMethodName   = "/chainguard.platform.iam.v2.GroupsService/CheckEligibility"
)
...
var GroupsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "chainguard.platform.iam.v2.GroupsService",
	...
	Metadata: "chainguard/platform/iam/v2/groups.proto",
}
