...
// UnaryRPC     :call TermsServiceServer directly.
...
func RegisterTermsServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TermsServiceServer) error {
	...
	mux.Handle("POST", pattern_TermsService_AcceptTerms_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/chainguard.platform.iam.v2beta1.TermsService/AcceptTerms", runtime.WithHTTPPathPattern("/iam/v2beta1/terms/{group=**}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_TermsService_AcceptTerms_0(annotatedContext, inboundMarshaler, server, req, pathParams)
	...
	mux.Handle("GET", pattern_TermsService_ListTermsAcceptances_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/chainguard.platform.iam.v2beta1.TermsService/ListTermsAcceptances", runtime.WithHTTPPathPattern("/iam/v2beta1/terms/{group=**}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_TermsService_ListTermsAcceptances_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
...
// RegisterTermsServiceHandlerFromEndpoint is same as RegisterTermsServiceHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterTermsServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
...
// RegisterTermsServiceHandler registers the http handlers for service TermsService to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterTermsServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterTermsServiceHandlerClient(ctx, mux, NewTermsServiceClient(conn))
}

// RegisterTermsServiceHandlerClient registers the http handlers for service TermsService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "TermsServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "TermsServiceClient"
...
func RegisterTermsServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TermsServiceClient) error {
	...
	mux.Handle("POST", pattern_TermsService_AcceptTerms_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chainguard.platform.iam.v2beta1.TermsService/AcceptTerms", runtime.WithHTTPPathPattern("/iam/v2beta1/terms/{group=**}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_TermsService_AcceptTerms_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_TermsService_ListTermsAcceptances_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chainguard.platform.iam.v2beta1.TermsService/ListTermsAcceptances", runtime.WithHTTPPathPattern("/iam/v2beta1/terms/{group=**}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_TermsService_ListTermsAcceptances_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_TermsService_AcceptTerms_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 3, 0, 4, 1, 5, 3}, []string{"iam", "v2beta1", "terms", "group"}, ""))

	pattern_TermsService_ListTermsAcceptances_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 3, 0, 4, 1, 5, 3}, []string{"iam", "v2beta1", "terms", "group"}, ""))
)
