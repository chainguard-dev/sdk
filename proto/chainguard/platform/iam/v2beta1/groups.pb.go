...
const file_chainguard_platform_iam_v2beta1_groups_proto_rawDesc = "" +
	...
	"lSend an access request from the caller to the owners of the verified root group matching their email domain.\x10\x01\x12\xaa\x02\n" +
	"\x10CheckEligibility\x128.chainguard.platform.iam.v2beta1.CheckEligibilityRequest\x1a9.chainguard.platform.iam.v2beta1.CheckEligibilityResponse\"\xa0\x01\x82\xd3\xe4\x93\x02&\x12$/iam/v2beta1/groups:checkEligibility\x8a\xaf\xa8\xd2\x05\x04\x12\x02\x10\x01\x9a\xaf\xa8\xd2\x05d\n" +
	"^Check whether the caller's email domain is eligible for email-domain-gated group access flows.\x10\x01\x18\x01Bn\n" +
