...
// UnaryRPC     :call ScimUsersServiceServer directly.
...
func RegisterScimUsersServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ScimUsersServiceServer) error {
	...
	mux.Handle("GET", pattern_ScimUsersService_ListScimUsers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ScimUsersService_ListScimUsers_0(annotatedContext, inboundMarshaler, server, req, pathParams)
...
// RegisterScimUsersServiceHandlerFromEndpoint is same as RegisterScimUsersServiceHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterScimUsersServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
...
// RegisterScimUsersServiceHandler registers the http handlers for service ScimUsersService to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterScimUsersServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterScimUsersServiceHandlerClient(ctx, mux, NewScimUsersServiceClient(conn))
}

// RegisterScimUsersServiceHandlerClient registers the http handlers for service ScimUsersService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "ScimUsersServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "ScimUsersServiceClient"
...
func RegisterScimUsersServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ScimUsersServiceClient) error {
	...
	mux.Handle("GET", pattern_ScimUsersService_ListScimUsers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ScimUsersService_ListScimUsers_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_ScimUsersService_ListScimUsers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 3, 0, 4, 1, 5, 3, 2, 4}, []string{"iam", "v2beta1", "identityProviders", "parent", "scimUsers"}, ""))
)

var (
	forward_ScimUsersService_ListScimUsers_0 = runtime.ForwardResponseMessage
)
