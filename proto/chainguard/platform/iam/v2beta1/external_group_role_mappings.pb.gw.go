...
// UnaryRPC     :call ExternalGroupRoleMappingsServiceServer directly.
...
func RegisterExternalGroupRoleMappingsServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ExternalGroupRoleMappingsServiceServer) error {
	...
	mux.Handle("GET", pattern_ExternalGroupRoleMappingsService_GetExternalGroupRoleMapping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/chainguard.platform.iam.v2beta1.ExternalGroupRoleMappingsService/GetExternalGroupRoleMapping", runtime.WithHTTPPathPattern("/iam/v2beta1/externalGroupRoleMappings/{uid=**}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ExternalGroupRoleMappingsService_GetExternalGroupRoleMapping_0(annotatedContext, inboundMarshaler, server, req, pathParams)
	...
	mux.Handle("POST", pattern_ExternalGroupRoleMappingsService_CreateExternalGroupRoleMapping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/chainguard.platform.iam.v2beta1.ExternalGroupRoleMappingsService/CreateExternalGroupRoleMapping", runtime.WithHTTPPathPattern("/iam/v2beta1/externalGroupRoleMappings/{parent=**}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ExternalGroupRoleMappingsService_CreateExternalGroupRoleMapping_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
	...
	mux.Handle("DELETE", pattern_ExternalGroupRoleMappingsService_DeleteExternalGroupRoleMapping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/chainguard.platform.iam.v2beta1.ExternalGroupRoleMappingsService/DeleteExternalGroupRoleMapping", runtime.WithHTTPPathPattern("/iam/v2beta1/externalGroupRoleMappings/{uid=**}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ExternalGroupRoleMappingsService_DeleteExternalGroupRoleMapping_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
	...
	mux.Handle("POST", pattern_ExternalGroupRoleMappingsService_BatchDeleteExternalGroupRoleMappings_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/chainguard.platform.iam.v2beta1.ExternalGroupRoleMappingsService/BatchDeleteExternalGroupRoleMappings", runtime.WithHTTPPathPattern("/iam/v2beta1/externalGroupRoleMappings:batchDelete"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ExternalGroupRoleMappingsService_BatchDeleteExternalGroupRoleMappings_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
	...
	mux.Handle("GET", pattern_ExternalGroupRoleMappingsService_ListExternalGroupRoleMappings_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/chainguard.platform.iam.v2beta1.ExternalGroupRoleMappingsService/ListExternalGroupRoleMappings", runtime.WithHTTPPathPattern("/iam/v2beta1/externalGroupRoleMappings"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ExternalGroupRoleMappingsService_ListExternalGroupRoleMappings_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
...
// RegisterExternalGroupRoleMappingsServiceHandlerFromEndpoint is same as RegisterExternalGroupRoleMappingsServiceHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterExternalGroupRoleMappingsServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
...
// RegisterExternalGroupRoleMappingsServiceHandler registers the http handlers for service ExternalGroupRoleMappingsService to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterExternalGroupRoleMappingsServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterExternalGroupRoleMappingsServiceHandlerClient(ctx, mux, NewExternalGroupRoleMappingsServiceClient(conn))
}

// RegisterExternalGroupRoleMappingsServiceHandlerClient registers the http handlers for service ExternalGroupRoleMappingsService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "ExternalGroupRoleMappingsServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "ExternalGroupRoleMappingsServiceClient"
...
func RegisterExternalGroupRoleMappingsServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ExternalGroupRoleMappingsServiceClient) error {
	...
	mux.Handle("GET", pattern_ExternalGroupRoleMappingsService_GetExternalGroupRoleMapping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chainguard.platform.iam.v2beta1.ExternalGroupRoleMappingsService/GetExternalGroupRoleMapping", runtime.WithHTTPPathPattern("/iam/v2beta1/externalGroupRoleMappings/{uid=**}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ExternalGroupRoleMappingsService_GetExternalGroupRoleMapping_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_ExternalGroupRoleMappingsService_CreateExternalGroupRoleMapping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chainguard.platform.iam.v2beta1.ExternalGroupRoleMappingsService/CreateExternalGroupRoleMapping", runtime.WithHTTPPathPattern("/iam/v2beta1/externalGroupRoleMappings/{parent=**}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ExternalGroupRoleMappingsService_CreateExternalGroupRoleMapping_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("DELETE", pattern_ExternalGroupRoleMappingsService_DeleteExternalGroupRoleMapping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chainguard.platform.iam.v2beta1.ExternalGroupRoleMappingsService/DeleteExternalGroupRoleMapping", runtime.WithHTTPPathPattern("/iam/v2beta1/externalGroupRoleMappings/{uid=**}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ExternalGroupRoleMappingsService_DeleteExternalGroupRoleMapping_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_ExternalGroupRoleMappingsService_BatchDeleteExternalGroupRoleMappings_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chainguard.platform.iam.v2beta1.ExternalGroupRoleMappingsService/BatchDeleteExternalGroupRoleMappings", runtime.WithHTTPPathPattern("/iam/v2beta1/externalGroupRoleMappings:batchDelete"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ExternalGroupRoleMappingsService_BatchDeleteExternalGroupRoleMappings_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_ExternalGroupRoleMappingsService_ListExternalGroupRoleMappings_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chainguard.platform.iam.v2beta1.ExternalGroupRoleMappingsService/ListExternalGroupRoleMappings", runtime.WithHTTPPathPattern("/iam/v2beta1/externalGroupRoleMappings"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ExternalGroupRoleMappingsService_ListExternalGroupRoleMappings_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_ExternalGroupRoleMappingsService_GetExternalGroupRoleMapping_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 3, 0, 4, 1, 5, 3}, []string{"iam", "v2beta1", "externalGroupRoleMappings", "uid"}, ""))

	pattern_ExternalGroupRoleMappingsService_CreateExternalGroupRoleMapping_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 3, 0, 4, 1, 5, 3}, []string{"iam", "v2beta1", "externalGroupRoleMappings", "parent"}, ""))

	pattern_ExternalGroupRoleMappingsService_DeleteExternalGroupRoleMapping_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 3, 0, 4, 1, 5, 3}, []string{"iam", "v2beta1", "externalGroupRoleMappings", "uid"}, ""))

	pattern_ExternalGroupRoleMappingsService_BatchDeleteExternalGroupRoleMappings_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"iam", "v2beta1", "externalGroupRoleMappings"}, "batchDelete"))

	pattern_ExternalGroupRoleMappingsService_ListExternalGroupRoleMappings_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"iam", "v2beta1", "externalGroupRoleMappings"}, ""))
)
