...
func (IdentityProvider_OIDC_CorrelationRule) EnumDescriptor() ([]byte, []int) {
	return file_chainguard_platform_iam_v2beta1_identity_providers_proto_rawDescGZIP(), []int{0, 0, 0}
}
...
func (IdentityProvider_OIDC_TokenEndpointAuthMethod) Descriptor() protoreflect.EnumDescriptor {
	return file_chainguard_platform_iam_v2beta1_identity_providers_proto_enumTypes[1].Descriptor()
}

func (IdentityProvider_OIDC_TokenEndpointAuthMethod) Type() protoreflect.EnumType {
	return &file_chainguard_platform_iam_v2beta1_identity_providers_proto_enumTypes[1]
}
...
func (IdentityProvider_OIDC_TokenEndpointAuthMethod) EnumDescriptor() ([]byte, []int) {
	return file_chainguard_platform_iam_v2beta1_identity_providers_proto_rawDescGZIP(), []int{0, 0, 1}
}
...
func (IdentityProvider_SCIM_CredentialState) Descriptor() protoreflect.EnumDescriptor {
	return file_chainguard_platform_iam_v2beta1_identity_providers_proto_enumTypes[2].Descriptor()
}

func (IdentityProvider_SCIM_CredentialState) Type() protoreflect.EnumType {
	return &file_chainguard_platform_iam_v2beta1_identity_providers_proto_enumTypes[2]
}
...
type IdentityProvider_OIDC struct {
	...
	CorrelationRule IdentityProvider_OIDC_CorrelationRule `protobuf:"varint,6,opt,name=correlation_rule,json=correlationRule,proto3,enum=chainguard.platform.iam.v2beta1.IdentityProvider_OIDC_CorrelationRule" json:"correlation_rule,omitempty"`
	...
	TokenEndpointAuthMethod IdentityProvider_OIDC_TokenEndpointAuthMethod `protobuf:"varint,8,opt,name=token_endpoint_auth_method,json=tokenEndpointAuthMethod,proto3,enum=chainguard.platform.iam.v2beta1.IdentityProvider_OIDC_TokenEndpointAuthMethod" json:"token_endpoint_auth_method,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
const file_chainguard_platform_iam_v2beta1_identity_providers_proto_rawDesc = "" +
	...
	"\fpkce_enabled\x18\a \x01(\bB\x04\xe2A\x01\x01R\vpkceEnabled\x12\x91\x01\n" +
	"\x1atoken_endpoint_auth_method\x18\b \x01(\x0e2N.chainguard.platform.iam.v2beta1.IdentityProvider.OIDC.TokenEndpointAuthMethodB\x04\xe2A\x01\x01R\x17tokenEndpointAuthMethod\"\x8d\x01\n" +
	...
	"-TOKEN_ENDPOINT_AUTH_METHOD_CLIENT_SECRET_POST\x10\x02\x1a\xf0\x04\n" +
	"\x04SCIM\x12\x1e\n" +
...
var file_chainguard_platform_iam_v2beta1_identity_providers_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
...
var file_chainguard_platform_iam_v2beta1_identity_providers_proto_goTypes = []any{
	(IdentityProvider_OIDC_CorrelationRule)(0),         // 0: chainguard.platform.iam.v2beta1.IdentityProvider.OIDC.CorrelationRule
	(IdentityProvider_OIDC_TokenEndpointAuthMethod)(0), // 1: chainguard.platform.iam.v2beta1.IdentityProvider.OIDC.TokenEndpointAuthMethod
	(IdentityProvider_SCIM_CredentialState)(0),         // 2: chainguard.platform.iam.v2beta1.IdentityProvider.SCIM.CredentialState
	(*IdentityProvider)(nil),                           // 3: chainguard.platform.iam.v2beta1.IdentityProvider
	(*ListIdentityProvidersRequest)(nil),               // 4: chainguard.platform.iam.v2beta1.ListIdentityProvidersRequest
	(*ListIdentityProvidersResponse)(nil),              // 5: chainguard.platform.iam.v2beta1.ListIdentityProvidersResponse
	(*GetIdentityProviderRequest)(nil),                 // 6: chainguard.platform.iam.v2beta1.GetIdentityProviderRequest
	(*CreateIdentityProviderRequest)(nil),              // 7: chainguard.platform.iam.v2beta1.CreateIdentityProviderRequest
	(*UpdateIdentityProviderRequest)(nil),              // 8: chainguard.platform.iam.v2beta1.UpdateIdentityProviderRequest
	(*DeleteIdentityProviderRequest)(nil),              // 9: chainguard.platform.iam.v2beta1.DeleteIdentityProviderRequest
	(*GenerateScimTokenRequest)(nil),                   // 10: chainguard.platform.iam.v2beta1.GenerateScimTokenRequest
	(*GenerateScimTokenResponse)(nil),                  // 11: chainguard.platform.iam.v2beta1.GenerateScimTokenResponse
	(*RegenerateScimTokenRequest)(nil),                 // 12: chainguard.platform.iam.v2beta1.RegenerateScimTokenRequest
	(*RegenerateScimTokenResponse)(nil),                // 13: chainguard.platform.iam.v2beta1.RegenerateScimTokenResponse
	(*RevokeScimTokenRequest)(nil),                     // 14: chainguard.platform.iam.v2beta1.RevokeScimTokenRequest
	(*RevokeScimTokenResponse)(nil),                    // 15: chainguard.platform.iam.v2beta1.RevokeScimTokenResponse
	(*SetScimEnabledRequest)(nil),                      // 16: chainguard.platform.iam.v2beta1.SetScimEnabledRequest
	(*SetScimEnabledResponse)(nil),                     // 17: chainguard.platform.iam.v2beta1.SetScimEnabledResponse
	(*IdentityProvider_OIDC)(nil),                      // 18: chainguard.platform.iam.v2beta1.IdentityProvider.OIDC
	(*IdentityProvider_SCIM)(nil),                      // 19: chainguard.platform.iam.v2beta1.IdentityProvider.SCIM
...
var file_chainguard_platform_iam_v2beta1_identity_providers_proto_depIdxs = []int32{
	20, // 0: chainguard.platform.iam.v2beta1.IdentityProvider.create_time:type_name -> google.protobuf.Timestamp
	20, // 1: chainguard.platform.iam.v2beta1.IdentityProvider.update_time:type_name -> google.protobuf.Timestamp
	18, // 2: chainguard.platform.iam.v2beta1.IdentityProvider.oidc:type_name -> chainguard.platform.iam.v2beta1.IdentityProvider.OIDC
	19, // 3: chainguard.platform.iam.v2beta1.IdentityProvider.scim:type_name -> chainguard.platform.iam.v2beta1.IdentityProvider.SCIM
	21, // 4: chainguard.platform.iam.v2beta1.ListIdentityProvidersRequest.uidp:type_name -> chainguard.platform.common.UIDPFilter
	3,  // 5: chainguard.platform.iam.v2beta1.ListIdentityProvidersResponse.identity_providers:type_name -> chainguard.platform.iam.v2beta1.IdentityProvider
	3,  // 6: chainguard.platform.iam.v2beta1.CreateIdentityProviderRequest.identity_provider:type_name -> chainguard.platform.iam.v2beta1.IdentityProvider
	3,  // 7: chainguard.platform.iam.v2beta1.UpdateIdentityProviderRequest.identity_provider:type_name -> chainguard.platform.iam.v2beta1.IdentityProvider
	22, // 8: chainguard.platform.iam.v2beta1.UpdateIdentityProviderRequest.update_mask:type_name -> google.protobuf.FieldMask
	20, // 9: chainguard.platform.iam.v2beta1.GenerateScimTokenRequest.expire_time:type_name -> google.protobuf.Timestamp
	20, // 10: chainguard.platform.iam.v2beta1.GenerateScimTokenResponse.expire_time:type_name -> google.protobuf.Timestamp
	23, // 11: chainguard.platform.iam.v2beta1.RegenerateScimTokenRequest.overlap:type_name -> google.protobuf.Duration
	20, // 12: chainguard.platform.iam.v2beta1.RegenerateScimTokenRequest.expire_time:type_name -> google.protobuf.Timestamp
	20, // 13: chainguard.platform.iam.v2beta1.RegenerateScimTokenResponse.expire_time:type_name -> google.protobuf.Timestamp
	20, // 14: chainguard.platform.iam.v2beta1.RegenerateScimTokenResponse.previous_token_expire_time:type_name -> google.protobuf.Timestamp
	23, // 15: chainguard.platform.iam.v2beta1.RegenerateScimTokenResponse.requested_overlap:type_name -> google.protobuf.Duration
	20, // 16: chainguard.platform.iam.v2beta1.RevokeScimTokenResponse.revoke_time:type_name -> google.protobuf.Timestamp
	0,  // 17: chainguard.platform.iam.v2beta1.IdentityProvider.OIDC.correlation_rule:type_name -> chainguard.platform.iam.v2beta1.IdentityProvider.OIDC.CorrelationRule
	1,  // 18: chainguard.platform.iam.v2beta1.IdentityProvider.OIDC.token_endpoint_auth_method:type_name -> chainguard.platform.iam.v2beta1.IdentityProvider.OIDC.TokenEndpointAuthMethod
	20, // 19: chainguard.platform.iam.v2beta1.IdentityProvider.SCIM.token_expire_time:type_name -> google.protobuf.Timestamp
	20, // 20: chainguard.platform.iam.v2beta1.IdentityProvider.SCIM.previous_token_expire_time:type_name -> google.protobuf.Timestamp
	2,  // 21: chainguard.platform.iam.v2beta1.IdentityProvider.SCIM.credential_state:type_name -> chainguard.platform.iam.v2beta1.IdentityProvider.SCIM.CredentialState
	4,  // 22: chainguard.platform.iam.v2beta1.IdentityProvidersService.ListIdentityProviders:input_type -> chainguard.platform.iam.v2beta1.ListIdentityProvidersRequest
	6,  // 23: chainguard.platform.iam.v2beta1.IdentityProvidersService.GetIdentityProvider:input_type -> chainguard.platform.iam.v2beta1.GetIdentityProviderRequest
	7,  // 24: chainguard.platform.iam.v2beta1.IdentityProvidersService.CreateIdentityProvider:input_type -> chainguard.platform.iam.v2beta1.CreateIdentityProviderRequest
	8,  // 25: chainguard.platform.iam.v2beta1.IdentityProvidersService.UpdateIdentityProvider:input_type -> chainguard.platform.iam.v2beta1.UpdateIdentityProviderRequest
	9,  // 26: chainguard.platform.iam.v2beta1.IdentityProvidersService.DeleteIdentityProvider:input_type -> chainguard.platform.iam.v2beta1.DeleteIdentityProviderRequest
	10, // 27: chainguard.platform.iam.v2beta1.IdentityProvidersService.GenerateScimToken:input_type -> chainguard.platform.iam.v2beta1.GenerateScimTokenRequest
	12, // 28: chainguard.platform.iam.v2beta1.IdentityProvidersService.RegenerateScimToken:input_type -> chainguard.platform.iam.v2beta1.RegenerateScimTokenRequest
	14, // 29: chainguard.platform.iam.v2beta1.IdentityProvidersService.RevokeScimToken:input_type -> chainguard.platform.iam.v2beta1.RevokeScimTokenRequest
	16, // 30: chainguard.platform.iam.v2beta1.IdentityProvidersService.SetScimEnabled:input_type -> chainguard.platform.iam.v2beta1.SetScimEnabledRequest
	5,  // 31: chainguard.platform.iam.v2beta1.IdentityProvidersService.ListIdentityProviders:output_type -> chainguard.platform.iam.v2beta1.ListIdentityProvidersResponse
	3,  // 32: chainguard.platform.iam.v2beta1.IdentityProvidersService.GetIdentityProvider:output_type -> chainguard.platform.iam.v2beta1.IdentityProvider
	3,  // 33: chainguard.platform.iam.v2beta1.IdentityProvidersService.CreateIdentityProvider:output_type -> chainguard.platform.iam.v2beta1.IdentityProvider
	3,  // 34: chainguard.platform.iam.v2beta1.IdentityProvidersService.UpdateIdentityProvider:output_type -> chainguard.platform.iam.v2beta1.IdentityProvider
	24, // 35: chainguard.platform.iam.v2beta1.IdentityProvidersService.DeleteIdentityProvider:output_type -> google.protobuf.Empty
	11, // 36: chainguard.platform.iam.v2beta1.IdentityProvidersService.GenerateScimToken:output_type -> chainguard.platform.iam.v2beta1.GenerateScimTokenResponse
	13, // 37: chainguard.platform.iam.v2beta1.IdentityProvidersService.RegenerateScimToken:output_type -> chainguard.platform.iam.v2beta1.RegenerateScimTokenResponse
	15, // 38: chainguard.platform.iam.v2beta1.IdentityProvidersService.RevokeScimToken:output_type -> chainguard.platform.iam.v2beta1.RevokeScimTokenResponse
	17, // 39: chainguard.platform.iam.v2beta1.IdentityProvidersService.SetScimEnabled:output_type -> chainguard.platform.iam.v2beta1.SetScimEnabledResponse
