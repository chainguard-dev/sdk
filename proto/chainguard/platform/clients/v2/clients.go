...
import (
	...
	advisory "chainguard.dev/sdk/proto/chainguard/platform/advisory/v2"
	iamv2 "chainguard.dev/sdk/proto/chainguard/platform/iam/v2"
...
// Clients provides access to v2 API clients.
...
// NewClients creates a v2 API gRPC client. The caller is responsible for closing the connection.
